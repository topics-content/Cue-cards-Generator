---
title: Agenda
description: Overview of topics covered in this multi-class classification session
duration: 180
card_type: cue_card
---
...
---
title: Setting The Scene GreenSort
description: Introduces the GreenSort recycling sorter case study that we will use throughout the session
duration: 300
card_type: cue_card
---
...
---
title: Section 1 From One Decision to Many
description: Extending single-neuron classification into a multi-neuron network with shared notation
duration: 660
card_type: cue_card
---
...
<span style="color: violet;">Question: Can a single Logistic Regression neuron decide between Paper, Plastic, and Metal directly?</span>
...
<span style="color: violet;">Question: So how do we modify our approach?</span>
...
---
title: Quiz 1
description: Counting weight parameters in GreenSorts network
duration: 90
card_type: quiz_card
---
...
description: Explains why the network needs 6 weight parameters
duration: 120
card_type: cue_card
---
...
---
title: Section 2 Packing the Network Into Matrices
description: Vectorizing the multi-neuron computation as Z equals XW plus b
duration: 480
card_type: cue_card
---
...
---
title: Quiz 2
description: Determining the shape of Z from X and W
duration: 90
card_type: quiz_card
---
...
description: Explains why Z has shape 12 by 3
duration: 180
card_type: cue_card
---
...
description: Introduces softmax as the fix for independent sigmoid outputs
duration: 480
card_type: cue_card
---
...
We need a function that takes in `z1, z2, z3` and returns three numbers that are all non-negative and sum to exactly 1. That function is called **softmax**.
...
---
title: Quiz 3
description: Identifying which bin gets the highest softmax probability
duration: 90
card_type: quiz_card
---
...
- [ ] Plastic
- [ ] Metal
- [ ] All three will be exactly equal

---
title: Quiz 3 Explanation
description: Explains why Paper gets the highest probability
duration: 90
card_type: cue_card
---
...
description: Sliders to observe how softmax redistributes confidence
duration: 420
card_type: cue_card
---
...
description: Prompt connecting softmax to the Boltzmann distribution
duration: 180
card_type: cue_card
---
...
description: Deriving Categorical Cross-Entropy from log loss using one-hot encoding
duration: 720
card_type: cue_card
---
...
<span style="color: violet;">Question: What loss function did we use for a single yes/no decision, back in Logistic Regression?</span>
...
---
title: Quiz 4
description: Calculating Categorical Cross-Entropy for a single item
duration: 90
card_type: quiz_card
---
...
- [x] -log(0.5)
- [ ] -log(0.3)
- [ ] -log(0.2) - log(0.5) - log(0.3)

---
title: Quiz 4 Explanation
description: Explains why the loss is negative log of 0.5
duration: 120
card_type: cue_card
---
...
---
title: AI Spotlight From Sorting Recyclables to Powering Language Models
description: Connecting GreenSort's pipeline to real-world large-scale systems
duration: 240
card_type: cue_card
---
...
---
title: Ask AI Vocabulary Sized Softmax in Language Models
description: Ask AI prompt comparing GreenSort softmax to LLM vocabulary softmax
duration: 180
card_type: cue_card
---
...
---
title: Section 5 Teaching GreenSort From Its Mistakes
description: The 5-step training loop and chef analogy
duration: 480
card_type: cue_card
---
...
You can think of this loop the way a chef refines a recipe: taste the dish (forward propagation), decide how far it is from what was intended (loss), work out which specific ingredient caused the problem and by how much (backward propagation), then adjust that ingredient's quantity slightly (update), and test again.

---
title: Forward Propagation Revisited
description: Recap of the forward pass and its computational graph
duration: 240
card_type: cue_card
---
...
---
title: Backward Propagation Assigning Blame
description: Chain rule derivation using the relay race analogy
duration: 600
card_type: cue_card
---
...
---
title: Quiz 5
description: What backward propagation computes first
duration: 90
card_type: quiz_card
---
...
- [ ] The updated value of W
- [x] How J changes with respect to P, i.e. dJ/dP
- [ ] The value of X
- [ ] The learning rate

---
title: Quiz 5 Explanation
description: Why dJ/dP is computed first in backward propagation
duration: 90
card_type: cue_card
---
...
---
title: Ask AI Deriving dJ by dz for Softmax and Cross Entropy
description: Ask AI prompt deriving dJ/dz and comparing it to the chain rule explanation
duration: 150
card_type: cue_card
---
...
---
title: Interactive Playground NN Visualiser
description: IFrame embed to visualise forward and backward propagation
duration: 480
card_type: cue_card
---
...
---
title: Wrap Up
description: Summary of everything covered in this session
duration: 360
card_type: cue_card
---
